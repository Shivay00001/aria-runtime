...
from aria.models.types import (ActionType, KernelConfig, PromptRequest, RawModelResponse,
                                   ToolPermission, new_id, sha256_str)
...
class MockProvider:
    ...
    def estimate_tokens(self, request): return 100
